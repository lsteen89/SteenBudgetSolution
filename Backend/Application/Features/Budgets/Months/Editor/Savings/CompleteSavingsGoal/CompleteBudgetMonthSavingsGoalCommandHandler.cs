...
public sealed class CompleteBudgetMonthSavingsGoalCommandHandler
    : IRequestHandler<CompleteBudgetMonthSavingsGoalCommand, Result<BudgetMonthSavingsGoalEditorRowDto?>>
{
    ...
    public CompleteBudgetMonthSavingsGoalCommandHandler(
    ...
    public Task<Result<BudgetMonthSavingsGoalEditorRowDto?>> Handle(
        CompleteBudgetMonthSavingsGoalCommand cmd,
