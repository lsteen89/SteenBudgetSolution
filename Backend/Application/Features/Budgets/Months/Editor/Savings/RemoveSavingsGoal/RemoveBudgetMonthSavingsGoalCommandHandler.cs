...
public sealed class RemoveBudgetMonthSavingsGoalCommandHandler
    : IRequestHandler<RemoveBudgetMonthSavingsGoalCommand, Result<BudgetMonthSavingsGoalEditorRowDto?>>
{
    ...
    public RemoveBudgetMonthSavingsGoalCommandHandler(
    ...
    public Task<Result<BudgetMonthSavingsGoalEditorRowDto?>> Handle(
        RemoveBudgetMonthSavingsGoalCommand cmd,
