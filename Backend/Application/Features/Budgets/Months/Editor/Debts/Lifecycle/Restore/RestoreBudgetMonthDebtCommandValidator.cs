...
public sealed class RestoreBudgetMonthDebtCommandValidator
    : AbstractValidator<RestoreBudgetMonthDebtCommand>
{
    public RestoreBudgetMonthDebtCommandValidator()
    {
