...
{
    // user-scoped (Guid)
    Task<RateLimitDecision> CheckAsync(Guid persoId, EmailKind kind, CancellationToken ct);
    Task MarkSentAsync(Guid persoId, EmailKind kind, DateTimeOffset sentAtUtc, CancellationToken ct);
