...
{
    [Obsolete("This class is deprecated and will be removed in a future version. Use IVerificationTokenSqlExecutor instead.")]
    public class LegacyVerificationTokenSqlExecutor : SqlBase, ILegacyVerificationTokenSqlExecutor
    {
        public LegacyVerificationTokenSqlExecutor(IConnectionFactory connectionFactory, ILogger<LegacyVerificationTokenSqlExecutor> logger)
