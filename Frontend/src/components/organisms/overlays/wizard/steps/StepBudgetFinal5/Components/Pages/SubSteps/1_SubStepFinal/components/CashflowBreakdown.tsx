...
function CashflowBreakdown({
    ...
    const rows = [
        ...
        { label: "Sparande (vanor)", value: -ui.habitSavingsMonthly, tone: "neg" as const },
        { label: "Mål", value: -ui.goalSavingsMonthly, tone: "neg" as const },
        { label: "Skulder (minimi)", value: -ui.totalDebtPayments, tone: "neg" as const },
    ];
            ...
            <div className="relative z-10 mt-3 space-y-2">
                ...
                <div className="mt-3 pt-3 border-t border-wizard-stroke/20 flex items-baseline justify-between gap-4">
                    ...
                    <span className="flex items-baseline gap-2 font-mono tabular-nums">
                        ...
                        <span className="text-sm font-semibold text-wizard-text/55">/mån</span>
                    </span>
                </div>
            </div>
        </div>
