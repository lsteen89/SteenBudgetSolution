...
export default function DebtItemRow({ index }: Props) {
    ...
    return (
        <div className="grid grid-cols-1 gap-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <div className="md:col-span-2">
                    ...
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <select {...field} id={idFromPath(`${base}.type`)} className={selectClass}>
                        ...
                        render={({ field, fieldState }) => (
                            <RowNumberInput
                                ...
                                onChange={(e) => {
                                    ...
                                    const next = parsed === null ? null : Number.isFinite(parsed) ? parsed : null;
                                    field.onChange(next);
                                }}
                                onBlur={field.onBlur}
                                error={fieldState.error?.message}
            ...
            {(type === "installment" || type === "bank_loan" || type === "revolving") ? (
                <div
                    className={cn(
                ...
                >
                    ...
                    <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                        {(type === "installment" || type === "bank_loan") && (
                            <div>
                                <label htmlFor={idFromPath(`${base}.termMonths`)} className={labelClass}>
                                    Löptid (mån)
                                </label>
                        ...
                        {(type === "installment" || type === "bank_loan") && (
                            <div>
                                <label htmlFor={idFromPath(`${base}.monthlyFee`)} className={labelClass}>
                        ...
                        {type === "revolving" && (
                            <div className="sm:col-span-2">
                                <label htmlFor={idFromPath(`${base}.minPayment`)} className={labelClass}>
