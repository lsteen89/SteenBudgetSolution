...
export default function DebtStrategyPicker({
  ...
  const t = <K extends keyof typeof debtStrategyPickerDict.sv>(k: K) =>
    tDict(k, locale, debtStrategyPickerDict);
    ...
    <div className="pt-2">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-xs text-wizard-text/60">{t("subtitle")}</p>
        </div>
        ...
        >
          {t("chooseLater")} <ChevronRight className="h-4 w-4" />
        </button>
      </div>
...
export const debtStrategyPickerDict = {
  sv: {
    title: "Välj strategi",
    subtitle: "Välj det som passar dig — du kan alltid ändra senare.",
    chooseLater: "Jag vill välja senare",

    avalancheTitle: "Lavinen",
    snowballTitle: "Snöbollen",
  },

  en: {
    title: "Choose a strategy",
    subtitle: "Choose what suits you — you can always change it later.",
    chooseLater: "I want to choose later",
  ...
  et: {
    title: "Vali strateegia",
    subtitle: "Vali see, mis sulle sobib — saad seda hiljem alati muuta.",
    chooseLater: "Soovin valida hiljem",

    avalancheTitle: "Laviin",
    snowballTitle: "Lumepall",
  },
} as const;
