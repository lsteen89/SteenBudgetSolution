...
type DeleteIncomeItemDialogProps = {
  open: boolean;
...
export default function DeleteIncomeItemDialog({
  open,
  itemName,
  isDeleting = false,
  onClose,
  onConfirm,
}: DeleteIncomeItemDialogProps) {
  ...
  return (
    ...
    >
      <button
        type="button"
        aria-label={t("deleteDialogCloseAriaLabel")}
        onClick={onClose}
