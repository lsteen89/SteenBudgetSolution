export const closedMonthRecapDict = {
  sv: {
    ...
    chartBody:
      "En låst visuell vy byggd från samma översiktsdata som totalsummorna ovan.",
  ...
  en: {
    ...
    chartBody:
      "A locked visual view built from the same recap data as the totals above.",
  ...
  et: {
    ...
    chartBody:
      "Lukustatud visuaalne vaade, mis kasutab samu kokkuvõtteandmeid nagu ülal olevad kogusummad.",
