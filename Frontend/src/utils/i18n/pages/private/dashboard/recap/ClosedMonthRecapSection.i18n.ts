export const closedMonthRecapDict = {
  sv: {
    ...
    completedGoalsTitle: "Sparmål uppnådda",
    completedGoalsRowSummary: "{name} nådde sitt mål den här månaden.",
    completedGoalsReachedLabel: "Nådde",
    completedGoalsTargetLabel: "Mål",
    completedGoalsRowLabel: "{name} uppnått sparmål",
    completedGoalsProgressLabel: "{percent}% av målet",
  ...
  en: {
    ...
    completedGoalsTitle: "Savings goals reached",
    completedGoalsRowSummary: "{name} reached its goal this month.",
    completedGoalsReachedLabel: "Reached",
    completedGoalsTargetLabel: "Goal",
    completedGoalsRowLabel: "{name} completed savings goal",
    completedGoalsProgressLabel: "{percent}% of goal",
  ...
  et: {
    ...
    completedGoalsTitle: "Saavutatud säästueesmärgid",
    completedGoalsRowSummary: "{name} jõudis sel kuul oma eesmärgini.",
    completedGoalsReachedLabel: "Jõudis",
    completedGoalsTargetLabel: "Eesmärk",
    completedGoalsRowLabel: "{name} saavutatud säästueesmärk",
    completedGoalsProgressLabel: "{percent}% eesmärgist",
