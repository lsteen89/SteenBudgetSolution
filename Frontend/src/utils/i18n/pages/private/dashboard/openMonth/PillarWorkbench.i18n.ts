...
export const pillarWorkbenchDict = {
  en: {
    ...
    signalGoalRowSub: "{saved} of {target} · {monthly}/mo",
    signalGoalRowSubNoTarget: "{saved} saved · {monthly}/mo",
    signalDebtApr: "{apr}% APR",
    signalDebtRowSub: "{balance} · {monthly}/mo",
  ...
  sv: {
    ...
    signalGoalRowSub: "{saved} av {target} · {monthly}/mån",
    signalGoalRowSubNoTarget: "{saved} sparat · {monthly}/mån",
    signalDebtApr: "{apr}% ränta",
    signalDebtRowSub: "{balance} · {monthly}/mån",
  ...
  et: {
    ...
    signalGoalRowSub: "{saved} / {target} · {monthly}/kuu",
    signalGoalRowSubNoTarget: "{saved} kogutud · {monthly}/kuu",
    signalDebtApr: "{apr}% intress",
    signalDebtRowSub: "{balance} · {monthly}/kuu",
