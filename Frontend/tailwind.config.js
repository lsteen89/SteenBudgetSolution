module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "dashboard-bird":
          "url('/src/assets/Components/Background/DashboardBirdBackground.png')",
        "form-gradient": "linear-gradient(to bottom, #f3f4f6, #e5e7eb)",
      },
      fontFamily: {
        inter: ["Inter", "Roboto", "Montserrat", "sans-serif"],
      },
      backgroundSize: {
        cover: "cover",
      },
      colors: {
        ...
        boxShadow: {
          eb: "0 10px 30px rgb(var(--eb-shadow) / 0.10), 0 2px 10px rgb(var(--eb-shadow) / 0.06)",
        },
      ...
      animation: {
        ...
        "mascot-hello":
          "mascot-hello 520ms cubic-bezier(0.2, 0.9, 0.2, 1) both",
